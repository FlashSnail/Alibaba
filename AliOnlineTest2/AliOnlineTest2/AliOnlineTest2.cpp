// AliOnlineTest2.cpp : 定义控制台应用程序的入口点。
//
/*
#include "stdafx.h"
#include <iostream>
...
using namespace std;
/*
多多岛上有很多小火车, 在提茅斯机房由原来的放射性火车库排列改成了新的车库，每个车库只能存放一辆小火车，
每个小火车进到车库只能是单行。每个小火车出车库由一个天车把移动钢轨放到车库前，
然后该列上的小火车从下而上优先出库。你能帮胖总管实现火车出站调度吗？
a
/  \
b    c
/ \  /  \
